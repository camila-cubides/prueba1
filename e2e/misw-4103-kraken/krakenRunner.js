...
const escenariosDir = path.join('./', subfolder);
const featureTarget = './features/Example.feature';
const stepsTarget = './features/web/step_definitions/step.js';
...
funcionalidades.forEach(func => {
  ...
  const stepPath = path.join(funcPath, 'step.js');
